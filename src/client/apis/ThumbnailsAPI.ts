...
export default class ThumbnailsAPI extends BaseAPI {
  ...
  getAssetsThumbnails (
    options: GetAssetsThumbnailsOptions
  ): Promise<GetAssetsThumbnails> {
  ...
  getDeveloperProductIcons (
    options: GetDeveloperProductsIconsOptions
  ): Promise<GetDeveloperProductsIcons> {
  ...
  getGamePassesIcons (
    options: GetGamePassesIconsOptions
  ): Promise<GetGamePassesIcons> {
  ...
  getUniverseThumbnailIds (
    options: GetUniverseThumbnailsOptions
  ): Promise<GetUniverseThumbnails> {
    return this.request({
      requiresAuth: false,
      request: {
  ...
  getUniversesRootPlaceThumbnail (
    options: GetUniversesRootPlaceThumbnailsOptions
  ): Promise<GetUniversesRootPlaceThumbnails> {
  ...
  getUniversesThumbnailIds (
    options: GetUniversesThumbnailsOptions
  ): Promise<GetUniversesThumbnails> {
    const universeIdsQueryString = `universeIds=${options.universeIds.join(
      "&universeIds="
    )}`;
    return this.request({
  ...
  getUsersFullBodyAvatarImages (
    options: GetUsersFullBodyAvatarImagesOptions
  ): Promise<GetUsersFullBodyAvatarImages> {
  ...
  getUsersAvatarBustImages (
    options: GetUsersAvatarBustImagesOptions
  ): Promise<GetUsersAvatarBustImages> {
    const userIdsQueryString = `userIds=${options.userIds.join("&userIds=")}`;
    return this.request({
      requiresAuth: false,
      request: {
  ...
  ): Promise<GetUsersAvatarHeadShotsImages> {
    const userIdsQueryString = `userIds=${options.userIds.join("&userIds=")}`;
    return this.request({
      requiresAuth: false,
      request: {
  ...
  getUsersOutfitsImages (
    options: GetUsersOutfitsImagesOptions
  ): Promise<GetUsersOutfitsImages> {
