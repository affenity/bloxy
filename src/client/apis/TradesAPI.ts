...
export default class TradesAPI extends BaseAPI {
  ...
  getTradesByStatusType(
    options: GetTradesByStatusTypeOptions
  ): Promise<GetTradesByStatusType> {
    return this.request({
      requiresAuth: true,
      request: {
  ...
  getTradesCountByStatusType(
    options: GetTradesCountByStatusTypeOptions
  ): Promise<GetTradesCountByStatusType> {
    return this.request({
      requiresAuth: true,
      request: {
  ...
  canTradeWith(
    options: CanSelfTradeWithUserOptions
  ): Promise<CanSelfTradeWithUser> {
    return this.request({
      requiresAuth: true,
      request: {
