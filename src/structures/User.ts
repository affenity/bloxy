...
export class UserBase {
  ...
  getOutfits (
    options: Omit<GetUserOutfitsOptions, "userId">
  ): Promise<GetUserOutfits> {
  ...
  getBadges (
    options?: Omit<GetUserBadgesOptions, "userId">
  ): Promise<CursorPage<GetUserBadges["data"][0]>> {
      ...
      .then(
        response =>
          new CursorPageClass(
            ...
            response,
            this.getBadges
          ) as CursorPage<GetUserBadges["data"][0]>
      );
  }

  getBadgesAwardedDates (
    badges: number[]
  ): Promise<{ id: number; awardedAt: Date }[]> {
    return this.client.apis.badgesAPI
  ...
  getBundles (
    options?: Omit<GetUserBundlesOptions, "userId">
  ): Promise<CursorPage<GetUserBundles["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;

    return this.client.apis.catalogAPI
      .getUserBundles({
        ...options,
        userId: this.id
      })
  ...
  getBundlesByType (
    bundleType: string,
    options?: Omit<GetUserBundlesOptions, "userId">
  ): Promise<CursorPage<GetUserBundlesByType["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
  ...
  getTag (): Promise<GetUsersTags[0]> {
    return this.client.apis.contactsAPI
      .getUsersTags({
  ...
  getFollowers (
    options?: Omit<GetUserFollowersOptions, "userId">
  ): Promise<CursorPage<GetUserFollowers["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
  ...
  getFollowing (
    options?: Omit<GetUserFollowingOptions, "userId">
  ): Promise<CursorPage<GetUserFollowing["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
  ...
  canInviteToVIPServer (): Promise<boolean> {
    return this.client.apis.gamesAPI
  ...
  awardBadge (badgeId: number, placeId: number): Promise<string> {
    return this.client.apis.generalApi
      .awardBadge({
        badgeId,
        placeId,
        userId: this.id
  ...
  getCollectibles (
    options?: Omit<GetUserCollectiblesOptions, "userId">
  ): Promise<CursorPage<GetUserCollectibles["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
  ...
  getItemsByTypeAndTargetId (
    ...
    id: number
  ): Promise<CursorPage<GetUserItemsByTypeAndTargetId["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
      ...
      .then(
        response =>
          new CursorPageClass(
            ...
            {},
            response,
            this.getItemsByTypeAndTargetId
          )
      );
  }

  getInventory (
    options: Omit<GetUserInventoryOptions, "userId">
  ): Promise<CursorPage<GetUserInventory["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
  ...
  getInventoryByAssetTypeId (
    options: Omit<GetUserInventoryByAssetTypeIdOptions, "userId">
  ): Promise<CursorPage<GetUserInventoryByAssetTypeId["data"][0]>> {
    const CursorPageClass = require("./Asset").CursorPage;
      ...
      .then(
        response =>
          new CursorPageClass(
            ...
            options,
            response,
            this.getInventoryByAssetTypeId
          )
      );
  }
  ...
  upsellPremiumCheck (
    options: Omit<PremiumUpsellCheckOptions, "userId">
  ...
  sendMessage (
    options: Omit<SendMessageOptions, "userId">
  ): Promise<SendMessage> {
  ...
  getFullBodyAvatarImage (
    options: Omit<GetUsersFullBodyAvatarImagesOptions, "userIds">
  ): Promise<GetUsersFullBodyAvatarImages["data"][0]> {
    return this.client.apis.thumbnailsAPI
      .getUsersFullBodyAvatarImages({
        ...options,
        userIds: [this.id]
      })
  ...
  getAvatarBustImage (
    options: Omit<GetUsersAvatarBustImagesOptions, "userIds">
  ): Promise<GetUsersAvatarBustImages["data"][0]> {
    return this.client.apis.thumbnailsAPI
      .getUsersAvatarBustImages({
        ...options,
        userIds: [this.id]
  ...
  getAvatarHeadShotImage (
    options: Omit<GetUsersAvatarHeadShotsImagesOptions, "userIds">
  ): Promise<GetUsersAvatarHeadShotsImages["data"][0]> {
    return this.client.apis.thumbnailsAPI
  ...
  getCanTrade (): Promise<boolean> {
    return this.client.apis.tradesAPI
      .canTradeWith({
        userId: this.id
      })
  ...
  updateTranslationGameAccess (
    options: Omit<UpdateUserAccess, "userId">
  ): Promise<UpdateUser> {
