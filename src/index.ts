...
export type {
    ...
    GetMetaData as AccountInformationAPIGetMetaData,
...
export type {
    CreateAssetAd,
    CreateAssetAdOptions,
    CreateGamePassAd,
    CreateGamePassAdOptions,
    CreateGroupAd,
    CreateGroupAdOptions
} from "./client/apis/AdsAPI";
export type {
    BaseAsset,
