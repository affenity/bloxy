...
const Chat_1 = require("../../../old_structures/Chat");
class ChatManager {
    constructor(client) {
        this.client = client;
    }
    ...
    getConversation(conversationId) {
        return this.getConversations([conversationId]).then((data) => data[0] || null);
    }
    ...
    getUnreadMessagesInConversations(conversations, amount = 100) {
        return this.client.apis.chatAPI
            ...
            .then((response) => Array.prototype.concat.apply([], response.map((conversationData) => conversationData.chatMessages.map((chatData) => new Chat_1.ChatMessage(chatData, this.client)))));
    }
