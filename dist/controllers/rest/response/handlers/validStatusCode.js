...
exports.validStatusCode = void 0;
...
function validStatusCode(response) {
    ...
    if (request.requestOptions.responseOptions &&
        ((_a = request.requestOptions.checks) === null || _a === void 0 ? void 0 : _a.statusCode)) {
        ...
        else if (allowedStatusCodes.length === 0 &&
    ...
    return isValid
        ...
        : new errors_1.BloxyHttpError({
            ...
            message: `Invalid status code in response. Body: ${responseData.body instanceof Object
...
exports.validStatusCode = validStatusCode;
