...
class GroupBase {
    ...
    getUniverses(options) {
        return this.client.apis.developAPI
            .getGroupUniverses(Object.assign(Object.assign({}, options), { groupId: this.id }))
            .then((response) => {
    ...
    getJoinRequests(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI
            .getJoinRequests(Object.assign({ groupId: this.id }, options))
    ...
    getMembersWithRole(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI
            .getMembersWithRole(Object.assign({ groupId: this.id }, options))
            .then((response) => new CursorPageClass(this.client, options, response, this.getMembersWithRole));
    }
    getMembers(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI
            .getMembers(Object.assign({ groupId: this.id }, options))
    ...
    getIsPendingJoin() {
        return this.client.apis.groupsAPI
            ...
            .then((response) => (response.data.find((groupData) => groupData.id === this.id) &&
            true) ||
            false);
    }
    changeOwner(userId) {
    ...
    getWallPosts(options) {
        const CursorPageClass = require("./Asset").CursorPage;
        return this.client.apis.groupsAPI
            .getWallPosts(Object.assign({ groupId: this.id }, options))
    ...
    getIsUserPrimaryGroup(userId) {
        return (this.client.apis.groupsAPI
            ...
            // eslint-disable-next-line @typescript-eslint/no-use-before-define
            .then((response) => response && response.group && response.role
            ? new GroupMember({
