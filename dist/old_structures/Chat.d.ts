...
import { ChatSendGameLinkMessageOptions, ChatSendMessageOptions } from "../client/apis/ChatAPI";
...
export declare class ChatConversation {
    ...
    addUsers(users: number[]): Promise<import("../client/apis/ChatAPI").ChatAddUsersToConversation>;
    removeUser(userId: number): Promise<import("../client/apis/ChatAPI").ChatRemoveUserFromConversation>;
    markMessageRead(id: string): Promise<import("../client/apis/ChatAPI").ChatMarkConversationMessagesRead>;
    markRead(): Promise<import("../client/apis/ChatAPI").ChatMarkConversationsSeen>;
    rename(name: string): Promise<import("../client/apis/ChatAPI").ChatRenameGroupConversation>;
    getUnreadMessages(amount?: number): Promise<ChatMessage[]>;
    getLatestMessages(amount?: number): Promise<ChatMessage[]>;
    resetUniverse(): Promise<import("../client/apis/ChatAPI").ChatResetConversationUniverse>;
