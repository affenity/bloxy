    ...
    constructor(data, client) {
        ...
        this.creatorType =
            data.creatorType.toLowerCase() === "group"
                ? constants_1.CreatorType.GROUP
                : constants_1.CreatorType.USER;
        this.creator =
            this.creatorType === constants_1.CreatorType.GROUP
        ...
        this.avatarType =
            data.universeAvatarType.toLowerCase() === "morphtor6"
                ? constants_1.MorphAvatarType.R6
                : constants_1.MorphAvatarType.R15;
