...
export declare class BasePlace {
    ...
    getCompatibilities(): Promise<import("../client/apis/DevelopAPI").DevelopGetPlaceCompatibilities>;
    updatePlaceConfiguration(options: {
        name: string;
        description: string;
    }): Promise<import("../client/apis/DevelopAPI").DevelopUpdatePlaceConfiguration>;
    getStatistics(options: Omit<DevelopGetPlaceStatisticsByTypeOptions, "placeId">): Promise<import("../client/apis/DevelopAPI").DevelopGetPlaceStatisticsByType>;
    awardBadge(userId: number, badgeId: number): Promise<boolean>;
    getGameServers(options: Omit<GamesGetGameServersByTypeOptions, "placeId">): Promise<import("../client/apis/GamesAPI").GamesGetGameServersByType>;
}
